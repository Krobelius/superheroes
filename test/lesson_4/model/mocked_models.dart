...
final superhero1 = Superhero(
  ...
  name: "Batman",
  biography: bio1,
  image: ServerImage(url:"https://www.superherodb.com/pictures2/portraits/10/100/639.jpg"),
...
final superhero2 = Superhero(
  ...
  name: "Ironman",
  biography: bio2,
  image: ServerImage(url:"https://www.superherodb.com/pictures2/portraits/10/100/100.jpg"),
  powerstats: powerstats1,
);
...
final superhero3 = Superhero(
  ...
  name: "Saloman",
  biography: bio3,
  image: ServerImage(url:"https://www.superherodb.com/pictures2/portraits/10/100/89.jpg"),
  powerstats: powerstats1,
);
...
final superhero4 = Superhero(
  ...
  name: "Chelovek-Nauk",
  biography: bio2,
  image: ServerImage(url:"https://www.superherodb.com/pictures2/portraits/10/100/200.jpg"),
  powerstats: powerstats1,
);
...
final superhero5 = Superhero(
  ...
  biography: bio3,
  image: ServerImage(url:"https://www.superherodb.com/pictures2/portraits/10/100/222.jpg"),
  powerstats: powerstats1,
);
